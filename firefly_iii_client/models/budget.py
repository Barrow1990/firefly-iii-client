...
class Budget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "auto_budget_amount", "auto_budget_currency_code", "auto_budget_currency_id", "auto_budget_period", "auto_budget_type", "created_at", "name", "notes", "order", "spent", "updated_at"]
