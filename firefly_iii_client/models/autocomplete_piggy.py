...
class AutocompletePiggy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency_code", "currency_decimal_places", "currency_id", "currency_name", "currency_symbol", "id", "name", "object_group_id", "object_group_title"]
